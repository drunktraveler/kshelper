...
export const HEROES = {
    ...
    "Alcar": {
        ...
        skills: [
            ...
            { name: "Carpe Diem", ids: [105, 106], units: ["inf", "cav", "arc"], values: [12, 24, 36, 48, 60], getChance: (X) => 1.0, getMagnitude: (X) => [
                    { inf: X/100 },           // Part 1: 60% to Infantry only (ID 105)
                    (X * 0.4166) / 100        // Part 2: 25% to ALL units (ID 106)
                ], 
                duration: 0 
            }
        ]
